...
class HSWaypointRunner(Node):
    ...
    def run(self):
        # Waypoint 1
        if not self._send_and_wait([0.0, 0.349066, 1.309, 0.0, 1.5708, 0.0]): return
        time.sleep(10.0)

        # Pickup Small [0.0, 0.610865, 1.309, -0.401426, 1.5708, 0.0]
        # Pickup Medium [0.0, 0.523599, 1.309, -0.349066, 1.5708, 0.296706]
        # Pickup Large [0.0, 0.523599, 1.309, -0.349066, 1.5708, 0.296706]
        # RTPickup [0.0, 0.0, 0.872665, 0.436332, 1.74533, 0.0]
        # Carry [0.0, 0.0, 0.0, 0.0, -1.5708, 0.0]
        # RTPlace [0.0, 0.0, 0.1.39626, 0.0, 1.1.72788, 0.0]
        # Place [0.0, 0.349066, 1.309, 0.0, 1.5708, 0.0]
